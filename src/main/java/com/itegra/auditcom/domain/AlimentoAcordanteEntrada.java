...
public class AlimentoAcordanteEntrada implements java.io.Serializable {
	...
	public AlimentoAcordanteEntrada(int crt, double percentualICMS, String ufEmitente, String ufDestinatario,
			double valorItem, double valorIPI, double valorFrete, double valorSeguro, double valorOutros, int cfop,
			String cnpjEmitente, String cnpjDestinatario, String categoria, String cst, String normaExecucao) {
		this.crt = crt;
		this.percentualICMS = percentualICMS;
		this.ufEmitente = ufEmitente;
		this.ufDestinatario = ufDestinatario;
