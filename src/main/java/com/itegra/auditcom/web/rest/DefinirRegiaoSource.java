...
public class DefinirRegiaoSource {

    private final KieService kieService;

    @Autowired
    public DefinirRegiaoSource(KieService kieService) {
    ...
    public ResultadoAlimentoAcordanteEntrada getRegiao(
        @RequestParam(required = false) String ufEmitente,
